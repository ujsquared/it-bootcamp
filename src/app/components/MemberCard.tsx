...
const MemberCard = ({ member }: { member: User }) => {
  ...
  return (
    <div
      className={`bg-white border border-black p-4 rounded-lg cursor-pointer transition-all duration-300 ${isExpanded ? "fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" : ""
        }`}
